...
suite("test_hot_value") {
    ...
    assertTrue(hotValues[0] == "7335560060985733464:50.00" || hotValues[0] == "1838281907459330133:50.00")
    assertTrue(hotValues[1] == "7335560060985733464:50.00" || hotValues[1] == "1838281907459330133:50.00")
    result = sql """show column cached stats test1(value1)"""
    assertEquals(1, result.size())
    assertEquals("10000.0", result[0][2])
    ...
    sql """alter table test1 modify column value1 set stats ('row_count'='5.0', 'ndv'='5.0', 'num_nulls'='0.0', 'data_size'='34.0', 'min_value'='AFRICA', 'max_value'='MIDDLE EAST', 'hot_value'='aaa:22.33');"""
    result = sql """show column stats test1(value1)"""
    assertEquals(1, result.size())
